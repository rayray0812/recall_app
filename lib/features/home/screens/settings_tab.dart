          ...
          child: Column(
            children: [
              ListTile(
                ...
                onTap: () =>
                    _showDisplaySettingsSheet(context: context, ref: ref),
              ),
              Divider(
                height: 1,
              ...
              ListTile(
                ...
                onTap: () {
                  ...
                  ScaffoldMessenger.of(
                    context,
                  ).showSnackBar(SnackBar(content: Text(l10n.pomodoroStarted)));
                },
              ),
              Divider(
                height: 1,
      ...
      builder: (dialogContext) {
        ...
        return StatefulBuilder(
          builder: (ctx, setDialogState) {
            ...
            final dialogWidth = media.width < 620 ? media.width * 0.86 : 520.0;
